    ...
    <section id="pricing" className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="h-full">
            <CardContent className="p-8 h-full flex flex-col">
              ...
              <div className="mb-6">
                <span className="text-4xl font-bold">5 CVs</span>
              ...
              <ul className="space-y-3 mb-8 flex-grow">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-600 mr-3 mb-4" />
          ...
          <Card className="relative border-blue-600 border-2 bg-blue-600 h-full">
            <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
              <Badge className="bg-orange-600 text-white">MOST POPULAR</Badge>
            </div>
            <CardContent className="p-8 text-white h-full flex flex-col">
        ...
        <div className="text-center mt-8 text-sm text-gray-600">
          💡 CVs at €1 each • 🇪🇺 VAT added for EU customers • 💳 Cancel anytime
        </div>
